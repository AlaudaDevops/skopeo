...
// Pin filepath-securejoin to v0.5.1: v0.6.0 removed deprecated top-level
// wrappers (OpenInRoot, OpenatInRoot, Reopen) that go.podman.io/storage
// v1.62.0 still calls. selinux v1.13.0 only declares v0.6.0 as a minimum
// but does not use the removed APIs, so this override is safe.
